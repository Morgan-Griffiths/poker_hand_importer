...
export const SUITS_ITOS: SuitsITOS = Object.fromEntries(
  Object.entries(SUITS_STOI).map((a) => a.reverse())
)
export const RANKS_ITOS: RanksITOS = {
  1: '2',
  2: '3',
  3: '4',
  4: '5',
...
export const POSITION_STOI: PositionsSTOI = Object.fromEntries(POSITIONS.map((p, i) => [p, i + 1]))
export const POSITION_ITOS: PositionsITOS = Object.fromEntries(
  Object.entries(POSITION_STOI).map((a) => a.reverse())
)

export const STREET_ITOS: StreetITOSType = {
  1: 'Preflop',
  2: 'Flop',
  3: 'Turn',
  4: 'River'
